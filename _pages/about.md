...
/* ─── CONVOYLLM-SPECIFIC STYLES ─── */
.lab-badvla-tag.convoy-its {
  background: #eff6ff; color: #1e40af; border: 1px solid #bfdbfe;
}
.lab-badvla-tag.convoy-llm {
  background: #f5f3ff; color: #6b21a8; border: 1px solid #ddd6fe;
}

/* Three-module explanation cards */
.lab-convoy-modules {
  display: grid;
...
.lab-convoy-module-icon {
  font-size: 1.8rem;
  margin-bottom: 0.5rem;
}
.lab-convoy-module-name {
  font-size: 0.85rem;
  font-weight: 700;
  color: var(--navy);
  margin-bottom: 0.4rem;
}
.lab-convoy-module-desc {
  font-size: 0.78rem;
  color: var(--gray-600);
  line-height: 1.65;
  text-align: left;
...
.lab-convoy-fig-item img {
  width: 100%;
  border-radius: var(--radius-md);
  border: 1px solid #e5e7eb;
}
.lab-convoy-fig-caption {
  font-size: 0.72rem;
  color: var(--gray-500);
  text-align: center;
  margin-top: 0.5rem;
...
/* Convoy demo: stays inside content padding for clean alignment */
.lab-badvla-demo.convoy-demo-full {
  margin: 0;
  padding-top: 1.5rem;
  border-top: 2px solid #e2e8f0;
}
/* Convoy demo grid: single video per row, full width */
.lab-badvla-demo-grid.convoy-single {
  max-width: 100%;
  padding: 0;
...
/* Driving scene videos: wide aspect ratio, with rounded corners */
.lab-badvla-demo-grid.convoy-single .lab-badvla-demo-video-wrap {
  aspect-ratio: 16 / 5;
  border-radius: var(--radius-sm);
  overflow: hidden;
}
/* Convoy video card: subtle border + rounded corners for breathing space */
.lab-badvla-demo-grid.convoy-single .lab-badvla-demo-card {
  background: #f8fafc;
  border: 1px solid #e2e8f0;
  border-radius: var(--radius-sm);
  overflow: hidden;
...
@media (max-width: 1024px) {
  .lab-convoy-modules { grid-template-columns: 1fr; }
  .lab-convoy-fig-row { grid-template-columns: 1fr; }
}
@media (max-width: 768px) {
  .lab-convoy-modules { grid-template-columns: 1fr; }
  .lab-convoy-fig-row { grid-template-columns: 1fr; }
  .lab-badvla-demo.convoy-demo-full { margin: 0; }
  .lab-badvla-demo-grid.convoy-single .lab-badvla-demo-video-wrap { aspect-ratio: 16 / 9; }
}
    ...
    <div class="lab-hero-right">
      <div class="lab-hero-card">
        ...
        <div class="lab-hero-links">
          ...
          <a class="lab-hero-link" href="http://faculty.hust.edu.cn/pzhou/zh_CN/index/1107001/list/index.htm" target="_blank">
...
<!-- ══════════════════════════════════════════════
     SECTION 3.5: CONVOYLLM RESEARCH HIGHLIGHT
     ══════════════════════════════════════════════ -->
<div class="lab-section" id="convoyllm">
  <div class="lab-badvla-header">
    <div class="lab-section-title-en">03 · Featured Research</div>
    <div class="lab-section-title-zh">代表性成果 · ConvoyLLM</div>
    <div class="lab-section-divider"></div>
  </div>
  ...
  <div class="lab-badvla-paper-card">
    <!-- Framework Figure -->
    <div class="lab-badvla-fig">
      <img src="/images/convoyllm/overview.png"
           alt="ConvoyLLM: Dynamic Multi-Lane Convoy Control Using LLMs — System Framework Overview"
           title="ConvoyLLM: Five-module framework for multi-lane convoy formation control"
           loading="lazy" />
    </div>
    ...
    <div class="lab-badvla-content">
      <!-- Paper badges -->
      <div class="lab-badvla-meta">
        <span class="lab-badvla-tag arxiv">📄 arXiv:2502.17529</span>
        <span class="lab-badvla-tag convoy-its">🚗 智能交通 / 编队控制</span>
        <span class="lab-badvla-tag convoy-llm">🧠 LLM 驱动决策</span>
        <span class="lab-badvla-tag venue">🎯 IROS 2025</span>
      </div>
      ...
      <!-- Authors -->
      <div class="lab-badvla-authors">
        Liping Lu, Zhican He, Duanfeng Chu*, Rukang Wang,
        Saiqian Peng, <span class="me">Pan Zhou</span>
        &nbsp;·&nbsp;
        <em>Wuhan University of Technology</em> &amp; <em>HUST</em>, 2025
      </div>
      ...
      <!-- Multi-module explanation cards (3 columns) -->
      <div class="lab-convoy-modules">
        <div class="lab-convoy-module-card">
          <div class="lab-convoy-module-icon">🧠</div>
          <div class="lab-convoy-module-name">推理模块</div>
          <div class="lab-convoy-module-desc">
            通过 LLM 对自车、环境车辆及邻居节点的感知信息进行综合推理，实时生成<strong>目标车道</strong>与<strong>目标速度</strong>决策，支持 IDLE（跟驰）、CHANGING（换道）、JOINING（加入）等多种动作输出。
          </div>
        </div>
        <div class="lab-convoy-module-card">
          <div class="lab-convoy-module-icon">🎯</div>
          <div class="lab-convoy-module-name">轨迹规划</div>
          <div class="lab-convoy-module-desc">
            采用<strong>交错编队</strong>策略（Interlaced Formation），相比平行编队提供更大换道空间，显著降低合并冲突。基于局部动态分布式图定义邻居节点，生成各车的平滑轨迹。
          </div>
        </div>
        <div class="lab-convoy-module-card">
          <div class="lab-convoy-module-icon">🎮</div>
          <div class="lab-convoy-module-name">控制执行</div>
          <div class="lab-convoy-module-desc">
            控制模块将规划轨迹转化为<strong>加速度</strong>与<strong>转向角</strong>指令，直接施加到仿真环境中。结合共享记忆机制，保障全车队决策的一致性与连续性。
          </div>
        </div>
      </div>

      <!-- Two detailed module figures side by side -->
      <div class="lab-convoy-fig-row">
        <div class="lab-convoy-fig-item">
          <img src="/images/convoyllm/ReasoningModule.png" alt="Reasoning Module Architecture" loading="lazy" />
          <div class="lab-convoy-fig-caption">推理模块架构：LLM 如何综合车辆感知信息做出决策</div>
        </div>
        <div class="lab-convoy-fig-item">
          <img src="/images/convoyllm/local_graph.png" alt="Trajectory Planning — Interlaced Formation" loading="lazy" />
          <div class="lab-convoy-fig-caption">轨迹规划：交错编队与局部动态邻居图</div>
        </div>
      </div>
      ...
      <div class="lab-badvla-results">
        ...
        <div class="lab-badvla-result-list">
          <div class="lab-badvla-result-item">
            <span class="icon">✓</span>
            在多种交通场景下实现<strong>有效的动态编队控制</strong>
          </div>
          <div class="lab-badvla-result-item">
            <span class="icon">✓</span>
            支持障碍物规避、编队加入/离开、护航切换等<strong>多种动态任务</strong>
          </div>
          <div class="lab-badvla-result-item">
            <span class="icon">✓</span>
            交错编队策略相比平行编队<strong>显著降低合并冲突</strong>
          </div>
          <div class="lab-badvla-result-item">
            <span class="icon">✓</span>
            对不同车速（20/30/40 km/h）和交通密度<strong>均保持鲁棒性</strong>
          </div>
          <div class="lab-badvla-result-item">
            <span class="icon">✓</span>
            SUMO 大规模仿真验证<strong>可扩展性和适应性</strong>
          </div>
          <div class="lab-badvla-result-item">
            <span class="icon">✓</span>
            首次将 LLM 应用于<strong>多车道动态编队协同控制</strong>
          </div>
        </div>
      </div>
      ...
      <!-- Links -->
      <div class="lab-badvla-links">
        <a class="lab-btn lab-btn-primary" href="https://arxiv.org/abs/2502.17529" target="_blank">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
          论文全文
        </a>
        <a class="lab-btn lab-btn-outline" href="https://github.com/he-zhican/ConvoyLLM" target="_blank">
          <svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/></svg>
          GitHub 代码
        </a>
        <a class="lab-btn lab-btn-outline" href="https://he-zhican.github.io/ConvoyLLM/" target="_blank">
          🌐 项目主页
        </a>
      </div>

    <!-- Video Demo -->
    <div class="lab-badvla-demo convoy-demo-full">
      <div class="lab-badvla-demo-title">SUMO 仿真实验演示</div>
      <div class="lab-badvla-demo-subtitle">展示 ConvoyLLM 在不同交通场景下的动态编队控制能力，包括不同车速下的障碍物规避、编队加入、编队离开和护航编队切换。更多演示请访问<a href="https://he-zhican.github.io/ConvoyLLM/" target="_blank" style="color:var(--teal);">项目主页</a>。</div>

      <!-- Avoiding Obstacles -->
      <div class="lab-badvla-demo-group-title">障碍物规避 · Avoiding Obstacles — 不同车速对比</div>
      <div class="lab-badvla-demo-grid convoy-single">
        <div class="lab-badvla-demo-card">
          <div class="lab-badvla-demo-video-wrap">
            <video controls preload="metadata" muted loop playsinline>
              <source src="/images/convoyllm/scene1_20.mp4" type="video/mp4" />
            </video>
          </div>
          <div class="lab-badvla-demo-card-body">
            <span class="lab-badvla-demo-card-label convoy">20 km/h ✅</span>
            <div class="lab-badvla-demo-card-desc">低速障碍物规避</div>
          </div>
        </div>
      </div>
      <div class="lab-badvla-demo-grid convoy-single">
        <div class="lab-badvla-demo-card">
          <div class="lab-badvla-demo-video-wrap">
            <video controls preload="metadata" muted loop playsinline>
              <source src="/images/convoyllm/scene1_30.mp4" type="video/mp4" />
            </video>
          </div>
          <div class="lab-badvla-demo-card-body">
            <span class="lab-badvla-demo-card-label convoy">30 km/h ✅</span>
            <div class="lab-badvla-demo-card-desc">中速障碍物规避</div>
          </div>
        </div>
      </div>
      <div class="lab-badvla-demo-grid convoy-single">
        <div class="lab-badvla-demo-card">
          <div class="lab-badvla-demo-video-wrap">
            <video controls preload="metadata" muted loop playsinline>
              <source src="/images/convoyllm/scene1_40.mp4" type="video/mp4" />
            </video>
          </div>
          <div class="lab-badvla-demo-card-body">
            <span class="lab-badvla-demo-card-label convoy">40 km/h ✅</span>
            <div class="lab-badvla-demo-card-desc">高速障碍物规避</div>
          </div>
        </div>
      </div>

      <!-- Joining The Convoy -->
      <div class="lab-badvla-demo-group-title">编队加入 · Joining The Convoy</div>
      <div class="lab-badvla-demo-grid convoy-single">
        <div class="lab-badvla-demo-card">
          <div class="lab-badvla-demo-video-wrap">
            <video controls preload="metadata" muted loop playsinline>
              <source src="/images/convoyllm/scene2.mp4" type="video/mp4" />
            </video>
          </div>
          <div class="lab-badvla-demo-card-body">
            <span class="lab-badvla-demo-card-label convoy">Join Convoy ✅</span>
            <div class="lab-badvla-demo-card-desc">单车加入多车道编队</div>
          </div>
        </div>
      </div>

      <!-- Leaving The Convoy -->
      <div class="lab-badvla-demo-group-title">编队离开 · Leaving The Convoy</div>
      <div class="lab-badvla-demo-grid convoy-single">
        <div class="lab-badvla-demo-card">
          <div class="lab-badvla-demo-video-wrap">
            <video controls preload="metadata" muted loop playsinline>
              <source src="/images/convoyllm/scene3.mp4" type="video/mp4" />
            </video>
          </div>
          <div class="lab-badvla-demo-card-body">
            <span class="lab-badvla-demo-card-label convoy">Leave Convoy ✅</span>
            <div class="lab-badvla-demo-card-desc">车辆安全离开编队</div>
          </div>
        </div>
      </div>

      <!-- Switching to Escort Formation -->
      <div class="lab-badvla-demo-group-title">护航编队切换 · Switching to Escort Formation</div>
      <div class="lab-badvla-demo-grid convoy-single">
        <div class="lab-badvla-demo-card">
          <div class="lab-badvla-demo-video-wrap">
            <video controls preload="metadata" muted loop playsinline>
              <source src="/images/convoyllm/scene4.mp4" type="video/mp4" />
            </video>
          </div>
          <div class="lab-badvla-demo-card-body">
            <span class="lab-badvla-demo-card-label convoy">Escort Formation ✅</span>
            <div class="lab-badvla-demo-card-desc">编队切换至护航阵型</div>
          </div>
        </div>
      </div>
    </div>
...
<div class="lab-section">
  <div class="lab-section-title">
    <div class="lab-section-title-en">05 · Research Directions</div>
...
<div class="lab-section lab-section-dark">
  <div class="lab-section-title">
    <div class="lab-section-title-en">06 · Latest News</div>
